...
<div class="quixnav">
    <div class="quixnav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a href="{{ url($adminURL.'dashboard') }}" aria-expanded="false"><i class="mdi mdi-home"></i><span class="nav-text">Dashboard</span></a></li>
			@if(in_array(1,$access_role) )
                <li>
                    ...
                    <ul aria-expanded="false">
                        <li><a href="{{ url($adminURL.'addCategory') }}">Add Category</a></li>
                        <li><a href="{{ url($adminURL.'listCategory') }}">Categories List</a></li>
                        <li><a href="{{ url($adminURL.'addSubcategory') }}">Add SubCategory</a></li>
                        <li><a href="{{ url($adminURL.'listSubCategory') }}">Subcategories List</a></li>                            
                    </ul>
                </li>
            	<li>
                    ...
                    <ul aria-expanded="false">
                        <li><a href="{{ url($adminURL.'listOrganizer') }}">Organizer List</a></li>
                        <li><a href="{{ url($adminURL.'addOrganizer') }}">Add Organizer</a></li>
                    </ul>
                </li>
            	<li>
                    ...
                    <ul aria-expanded="false">
                        <li><a href="{{ url($adminURL.'eventList') }}">Event List</a></li>                           
                    </ul>
                </li>
            	<li>
                    ...
                    <ul aria-expanded="false">
                        <li><a href="{{ url($adminURL.'promoterList') }}">Promoter List</a></li>
                        <li><a href="{{ url($adminURL.'add-promoter') }}">Add Promoter</a></li>                            
                    </ul>
                </li>                    
                <li>
                    ...
                    <ul aria-expanded="false">
                        <li><a href="{{ url($adminURL.'usersList') }}">User List</a></li>
                        <li><a href="{{ url($adminURL.'AddUser') }}">Add User</a></li>                            
                    </ul>
                </li>
            	<li>
                    ...
                    <ul aria-expanded="false">
                        <li><a href="{{ url($adminURL.'contactList') }}">Contact List</a></li>                           
                    </ul>
                </li>
	            <li>
                    ...
                    <ul aria-expanded="false">
                        <li><a href="{{ url($adminURL.'cms-pages-list') }}">Pages List</a></li>                            
                    </ul>
                </li>
				<li>
                    ...
                    <ul aria-expanded="false">
                        <li><a href="{{ url($adminURL.'add-plans') }}">Add Plan</a></li>
                        <li><a href="{{ url($adminURL.'list-plans') }}">Plan List</a></li>                            
                    </ul>
                </li>
            	<li>
                    ...
                    <ul aria-expanded="false">
                        <li><a href="{{ url($adminURL.'addTag') }}">Add Tags</a></li>
                        <li><a href="{{ url($adminURL.'listTags') }}">List Tags</a></li>                            
                    </ul>
                </li>
            @else
				@if(in_array(2,$access_role))
					<li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ url($adminURL.'list-payment') }}">Plans List</a></li>                            
                        </ul>
                    </li>
				@endif
