...
<script src="{{ asset('public/assets/js/layout-builder.js') }}"></script>
...
<script src="{{ asset('public/assets/vendors/custom/jquery-ui/jquery-ui.bundle.js')}}" type="text/javascript"></script>