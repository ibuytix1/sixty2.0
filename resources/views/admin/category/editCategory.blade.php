    ...
    <div class="container-fluid">
        ...
        <div class="row">
        	<div class="col-xl-12 col-xxl-12">
                <div class="card">
                    <div class="card-body">
						{{ Form::open(array('url' => config('constants.ADMIN_URL').'saveCategory','method' => 'post', 'id' => 'm_form_addCategory', 'files' => false)) }}
                            ...
                            <div class="basic-form">
                            	<div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" placeholder="Category Name" name="category_name" required="required" value="{{$data->category_name}}">
