                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center" style="padding-bottom:20px;">
                                        <img src="{{ asset('public/images/logo-2.jpg') }}" alt="ibuytix">
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <p style="text-align: center;">Your Reset Password Link</p>
                                        <p>Hello <?php echo ucwords($name);?>,</p>
                                        <p>Your Password Change link is here :</p>
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tbody>
                                                        <tr>
                                                            <td><a href="{{ $url }}" class="btn-primary">Change
                                                                    Password</a></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="content-block powered-by">
                                Powered by <a href="{{ url('/') }}">Event Booking</a>.
                            </td>
                        </tr>
                    </table>
                </div>
