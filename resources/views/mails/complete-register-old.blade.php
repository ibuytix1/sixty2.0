                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <p>Click on the activate account button to complete your registration :</p>
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tbody>
                                                        <tr>
                                                            <td><a href="{{ $url }}" class="btn-primary">Activate Account</a></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="content-block powered-by">
                                Powered by <a href="#">Event Booking</a>.
                            </td>
                        </tr>
                    </table>
                </div>
