...
<script type="text/javascript">
	...
	$(document).ready(function(){
        ...
        const viewOrgnizerProfile = "<?php echo e(url($adminURL.'viewOrgnizerProfile/')); ?>";
        const orgnizerListUrl = "<?php echo e(url($adminURL.'listOrganizerJson/')); ?>";
...
// 			"processing":true,
        ...
        organizerTable.on('click', '.active_user', function () {
            ...
            if (id != '') 
            {
                $.ajax({
                    type: 'post',
                    url: "<?php echo e(url('Admin/activeOrgnizer')); ?>",
		...
		$('#modal-warning').on('click', '.deleteConfirm', function(){
			...
			if (id != '') 
			{
				$.ajax({
                    type: 'post',
                    url: "<?php echo e(url('Admin/deleteOrganizer')); ?>",
                    data: 'id=' + id + '&_token=' + token,
					beforeSend: function() { },
					success: function (data) {
