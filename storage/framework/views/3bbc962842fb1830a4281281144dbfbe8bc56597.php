    	...
    	<div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="breadcrumb-range-picker">
                    ...
                    <span class="ml-1">Add Sub Category</span>
                </div>
            </div>
                            ...
                            <div class="basic-form">
                            	<div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <?php echo e(Form::select('category_id', $categoryList, null, ['placeholder' => 'Select Category', 'class' => 'form-control', 'data-live-search' => 'true'])); ?>

                                    </div>
                                    
                                    <div class="form-group col-md-12">
                                        <label class="">Subcategory Name</label>
                                        <input type="text" class="form-control" placeholder="Category Name" name="subcategory_name" required="required">
                                    </div>
                                </div>
