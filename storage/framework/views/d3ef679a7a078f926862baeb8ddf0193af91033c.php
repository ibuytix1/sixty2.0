                            ...
                            <table id="cms_page_list" class="display" style="min-width: 845px">
                                ...
                                <tbody>
									<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$pages): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<?php $k++;?>
    									<tr class="<?php echo e($pages->id); ?>">
    										<td><?php echo e($k); ?></td>
    										<td><?php echo e($pages->title); ?></td>
    										<td><?php echo e($pages->page_title); ?></td>
    										<td><?php echo e($pages->page_keyword); ?></td>
    										<td>
    											<div class="btn-group">
    												...
    												<ul class="dropdown-menu" role="menu">
    													<li>
    														<a href="<?php echo e(url($adminURL.'edit-cms-page/'.$pages->id)); ?>">Edit</a>
														</li>
    												</ul>
    											</div>
											</td>
