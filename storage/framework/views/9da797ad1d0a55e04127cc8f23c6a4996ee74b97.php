                            ...
                            <div class="basic-form">
                            	<div class="form-row">
                                    <div class="form-group col-md-6">
                                		...
                                		<input type="text" class="form-control" id="full-name" placeholder="Enter full name" name="first_name" required value="<?php echo e($data->first_name); ?>">
                                    </div>
                                    
                                    <div class="form-group col-md-6">
    	                                <label for="full_name">Last Name</label>
                                		<input type="text" class="form-control" id="full-name" placeholder="Enter full name" name="last_name" required value="<?php echo e($data->last_name); ?>">
	                                </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                		...
                                		<input type="text" class="form-control" id="email" placeholder="Enter email" name="email" disabled="disabled" value="<?php echo e($data->email); ?>">
                                		<div id="success"></div>
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <label for="about_promoter">About Organizer</label>
										<textarea class="form-control" rows="3" id="about_promoter" placeholder="About promoter..." name="about_promoter"><?php echo e($data->about_promoter); ?></textarea>
                                    </div>
                                </div>
