...
<head>
    ...
    <title><?php echo e(config('constants.admin_login')); ?></title>
                ...
                <div class="login-area p-t-100">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php echo e(Form::open(array('url' => config('constants.admin').'/get_login',
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="customCheck"
                                               name="remember" value="1" <?php echo e(Cookie::get('remember') ? 'checked' : ''); ?>>
                                        <label class="custom-control-label" for="customCheck">Remember Me</label>
                                    </div>

                                </div>
                                <div class="form-group col-md-6 text-right">
                                    <a href="<?php echo e(url($organizerURL.'forgot-password')); ?>">Forgot Password?</a>
                                </div>
                            </div>
    ...
    var SnippetLogin = function () {
        ...
        var handleSignInFormSubmit = function () {
            $('#m_login_signin_submit').click(function (e) {
                ...
                form.ajaxSubmit({
                    url: "<?php echo e(url('Admin/get_login')); ?>",
