...
<script type="text/javascript">
	...
	$(document).ready(function(){
		const editSubCategory = "<?php echo e(url($adminURL.'editSubCategory/')); ?>";
	    const listSubCategoryJson = "<?php echo e(url($adminURL.'listSubCategoryJson/')); ?>";
...
// 			"processing":true,
		...
		$('#modal-warning').on('click', '.deleteConfirm', function(){
			...
			if (id != '') 
			{
				$.ajax({
                    type: 'post',
                    url: "<?php echo e(url('Admin/deleteSubCategory')); ?>",
