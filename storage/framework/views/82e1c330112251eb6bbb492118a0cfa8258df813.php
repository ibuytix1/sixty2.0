                            ...
                            <div class="basic-form">
                            	<div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <?php echo e(Form::select('category_id', $categoryList,$data['category_id'], ['placeholder' => 'Select Category', 'class' => 'form-control', 'data-live-search' => 'true'])); ?>

                                    </div>
                                
									<div class="form-group col-md-12">
	                                    <label class="">Category Description</label>
                                        <textarea class="form-control" rows="4" id="comment" name="category_description" placeholder="About Category..."><?php echo e($data->category_description); ?></textarea>
                                    </div>
                                </div>
