...
<html lang="en">
    <head>
        ...
        <!-- Favicon icon -->
        <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(URL::asset('public/assets/admin/images/favicon.png')); ?>">
        <script src="<?php echo e(URL::asset('public/assets/admin/vendor/jquery/jquery.min.js')); ?>"></script>
        ...
        <?php echo $__env->make('admin.include.css', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    </head>
    <body>
        <!--*******************
            Preloader start
            ...
            ***********************************-->
            <div class="nav-header">
                <a href="index.html" class="brand-logo">
                    ...
                    <span class="logo-compact"><?php echo e(Session::get('user_data')['full_name']); ?></span>
                    <span class="brand-title"><?php echo e(Session::get('user_data')['full_name']); ?></span>
                </a>
                        ...
                        <div class="collapse navbar-collapse justify-content-end">
                            ...
                            <ul class="navbar-nav header-right">
                                ...
                                <li class="nav-item dropdown header-profile">
                                    <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <img src="<?php echo e(URL::asset('public/assets/admin/dist/img/avatar5.png')); ?>" alt="">
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <div class="dropdown-profile-header">
                                            <img src="<?php echo e(URL::asset('public/assets/admin/dist/img/avatar5.png')); ?>" alt="">
                                            <span class="avatar-name ml-2"><?php echo e(Session::get('user_data')['full_name']); ?></span>
                                        </div>
                                        ...
                                        <a href="<?php echo e(url($adminURL.'changePassword')); ?>" class="dropdown-item">
                                            <i class="mdi mdi-email"></i>
                                            <span>Change Password</span>
                                        </a>
                                        <a href="<?php echo e(url($adminURL.'logout')); ?>" class="dropdown-item">
