...
<script type="text/javascript">
	...
	$(document).ready(function(){
		const editContact = "<?php echo e(url($adminURL.'editContact/')); ?>";
	    const userManageRole = "<?php echo e(url($adminURL.'manage-role/')); ?>";
	    const userDetail = "<?php echo e(url($adminURL.'userDetail/')); ?>";
	    const listContactJson = "<?php echo e(url($adminURL.'listContactJson/')); ?>";
...
// 			"processing":true,
        ...
        $('#modal-warning').on('click', '.deleteConfirm', function(){
			...
			if (id != '') 
			{
				$.ajax({
                    type: 'post',
                    url: "<?php echo e(url('Admin/deleteContact')); ?>",
