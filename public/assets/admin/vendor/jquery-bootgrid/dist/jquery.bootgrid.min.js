...
! function(a, b, c) {
        ...
        if (0 !== this.options.navigation) {
            ...
            if (-1 !== this.rowCount && c.length > 0) {
                var d = this.options.templates,
                    ...
                    o = i >= n ? n : i;
                w.call(this, j, "first", "«", "first")._bgEnableAria(g > 1), w.call(this, j, "prev", "<", "prev")._bgEnableAria(g > 1);
                for (var p = 0; o > p; p++) {
                    var q = p + m;
                    w.call(this, j, q, q, "page-" + q)._bgEnableAria()._bgSelectAria(q === g)
                }
                0 === o && w.call(this, j, 1, 1, "page-1")._bgEnableAria(!1)._bgSelectAria(), w.call(this, j, "next", ">", "next")._bgEnableAria(i > g), w.call(this, j, "last", "»", "last")._bgEnableAria(i > g), E.call(this, c, j)
            }
        }
    }
    ...
    if (I.defaults = {
            ...
            css: {
                ...
                infos: "infos",
                left: "text-left",
                pagination: "pagination pagination-xs pagination-circle",
				pageItem: "page-item",
            ...
            templates: {
                ...
                paginationItem: '<li class="{{css.pageItem}}"><a data-page="{{ctx.page}}" class="{{css.paginationButton}}">{{ctx.text}}</a></li>',
